...
public class Base64 {
     ...
     * </pre>
     *
     * <p> Example: <code>encodeObject( myObj, Base64.GZIP )</code> or <p> Example:
     * <code>encodeObject( myObj, Base64.GZIP | Base64.DONT_BREAK_LINES )</code>
     *
     * @param serializableObject The object to encode
     * @param options            Specified options
     * @return The Base64-encoded object
     * @see com.vip.sdk.cart.common.utils.encoder.Base64#GZIP
     * @see com.vip.sdk.cart.common.utils.encoder.Base64#DONT_BREAK_LINES
     * @since 2.0
     */
        ...
        // Example: DkLE
            ...
            try {
                ...
                int
                    ...
                    ( ( DECODABET[source[srcOffset]] & 0xFF ) << 18 ) | (
                        ( DECODABET[source[srcOffset + 1]] & 0xFF ) << 12 ) | (
                        ( DECODABET[source[srcOffset + 2]] & 0xFF ) << 6 ) | ( ( DECODABET[source[
                        srcOffset + 3]] & 0xFF ) );
    ...
    /**
     * A {@link com.vip.sdk.cart.common.utils.encoder.Base64.InputStream} will read data from another <tt>java.io.InputStream</tt>, given
     * in the constructor, and encode/decode to/from Base64 notation on the fly.
     *
     * @see com.vip.sdk.cart.common.utils.encoder.Base64
     * @since 1.3
     */
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link com.vip.sdk.cart.common.utils.encoder.Base64.InputStream} in DECODE mode.
         *
        ...
        /**
         * Constructs a {@link com.vip.sdk.cart.common.utils.encoder.Base64.InputStream} in either ENCODE or DECODE mode. <p> Valid
         * options:
         *
         * <pre>
         ...
         * @param in      the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
         * @see com.vip.sdk.cart.common.utils.encoder.Base64#ENCODE
         * @see com.vip.sdk.cart.common.utils.encoder.Base64#DECODE
         * @see com.vip.sdk.cart.common.utils.encoder.Base64#DONT_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link com.vip.sdk.cart.common.utils.encoder.Base64.OutputStream} will write data to another <tt>java.io.OutputStream</tt>, given
     * in the constructor, and encode/decode to/from Base64 notation on the fly.
     *
     * @see com.vip.sdk.cart.common.utils.encoder.Base64
     * @since 1.3
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link com.vip.sdk.cart.common.utils.encoder.Base64.OutputStream} in ENCODE mode.
         *
        ...
        /**
         * Constructs a {@link com.vip.sdk.cart.common.utils.encoder.Base64.OutputStream} in either ENCODE or DECODE mode. <p> Valid
         * options:
         *
         * <pre>
         *    ENCODE or DECODE: Encode or Decode as data is read.
